...
\section{Key Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \begin{itemize}
          \itemsep-0.15em
          \item {Developing frameworks and models that could predict the typology of ad-hominem fallacies contained in a post given the sequence of preceding posts in the thread}
          \item {Extracting posts from popular subreddits and performing large-scale annotation study to generate our data set}
          \item {Decoding the dynamics of fallacies in arguments by reconstructing word weight heat map from the attention matrix of the model}
      \end{itemize}
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Machine Learning / Data Analysis}
      {Deep learning, including CNNs and RNNs; Machine learning, including SVM, KNN, Decision Trees and Bayes}
