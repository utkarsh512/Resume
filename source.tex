  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \begin{description}
        ...
        \item[$\circ$] {Used \textbf{Stochastic Gradient Descent} algorithm to get optimal weights and biases.}
 ...
 \section{Relevant Coursework}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Deep Learning}
      {\\\href{https://www.coursera.org/account/accomplishments/certificate/9HS82Y4DP4DV}{Neural Networks and Deep Learning*}}
    \resumeSubItem{Electronics and Communication Engineering}
      {\\Digital Speech Processing, Analog Electronics (+ lab), Signals \& Systems, Semiconductor Devices (+ lab), Electromagnetic Engineering}
    \resumeSubItem{Mathematics}
      {\\Graph Theory*, Probability and Stochastic Processes, Matrix Algebra}
  \resumeSubHeadingListEnd
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  & \it \textsuperscript{\#}ongoing courses, *courses completed online with assignments
\end{tabular*}
