...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href {https://utkarshiitkgp.github.io/}{\huge{Utkarsh Patel}}}\\ {2\textsuperscript{nd} Year Undergrad}& Email : \href{mailto:utkarshpatel@iitkgp.ac.in}{utkarshpatel@iitkgp.ac.in}\\
  \href{https://github.com/utkarshiitkgp}{GitHub: utkarshiitkgp} & Mobile : +91-95-4762-1111 \\
\end{tabular*}

%------------Interests----------------
\section{Interests}
  \resumeSubHeadingListStart
      {Algorithm Design, Graph Theory, Deep Learning, Computational Geometry, Probability \& Statistics}
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Major}
          {Electronics \& Electrical Communication Engineering | CGPA 9.62 / 10.0}
        \resumeItem{Minor}
          {Computer Science and Engineering | CGPA ~ / 10.0}
      \resumeItemListEnd
    \resumeSubheading
 ...
 \section{Relevant Coursework}
  \resumeSubHeadingListStart
    \resumeSubItem{Computer Science}
      {\\Deep Learning*, Algorithms (+ lab), Computational Geometry*, Programming and Data Structures (+ lab)}
    \resumeSubItem{Electronics and Communication}
      {\\Analog Electronic Circuits (+ lab), Semiconductor Devices (+ lab), Signals \& Systems, Electromagnetic Engg.}
    \resumeSubItem{Mathematics}
      {\\Graph Theory*, Probability and Stochastic Processes, Matrix Algebra}
  \resumeSubHeadingListEnd
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  & \it * denotes courses completed online
\end{tabular*}
...
\section{Scholastic Achievements}
  \resumeSubHeadingListStart
      \itemsep-0.5em
      \item{2019: Department rank 1 among 53 dual degree students at the end of third semester.}
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Programming Languages}
      {\\Python, C/C++, Octave, MySQL, Tcl/Tk}
    \resumeSubItem{Libraries / Frameworks}
      {\\pandas, scikit-learn, TensorFlow, NumPy, Sqlite, Django, tkinter}
    \resumeSubItem{Softwares / Platforms}
      {\\MATLAB, LTSpice, AWS, Jupyter, Git, \LaTeX, SolidWorks}
  \resumeSubHeadingListEnd
